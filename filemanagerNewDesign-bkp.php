    ...
    <link rel="stylesheet" href="https://rosnyc.com/admin/assets/mdb/css/mdb.min.css" />
      <div class="path">
       <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                <p class="card-text">
                    <a href="?action=filemanager&p=<?php echo FM_PATH ?>" class="float-right"><i class="fa fa-chevron-circle-left go-back"></i> <?php echo lng('Back')?></a>
                    <?php echo lng('DestinationFolder') ?>: <?php echo fm_enc(fm_convert_win(FM_PATH)) ?>
                </p>

                <form action="<?php echo "https://".$http_host. '/admin/filemanager/filemanagerNewDesign.php?action=filemanager&p=' . fm_enc(FM_PATH) ?>" class="dropzone card-tabs-container" id="fileUploader" enctype="multipart/form-data">
                ...
                <div class="upload-url-wrapper card-tabs-container hidden" id="urlUploader">
                    <form action="<?php echo "https://".$http_host. '/admin/filemanager/filemanagerNewDesign.php?action=filemanager&p=' . fm_enc(FM_PATH) ?>" id="js-form-url-upload" class="form-inline" onsubmit="return upload_from_url(this);" method="POST" action="">
                    <div class="form-outline">
                        <input type="hidden" name="type" value="upload" aria-label="hidden" aria-hidden="true">
                        <input type="url" name="uploadurl" required class="form-control" style="width: 80%">
                        <label class="form-label" for="form12">URL</label>
                    </div>
        ...
        <div class="apex-charts d-none" id="radial-chart"></div>
    </div>
            ...
            <div class="d-flex flex-column h-100">
                    ...
                    <ul class="list-unstyled categories-list">
                        <li>
                            <div class="custom-accordion">
                                <a href="javascript:;" id="collapseOneLink" class="text-body fw-medium py-1 d-flex align-items-center">
                                    <i class="fa fa-folder font-size-14 text-warning me-2"></i> Files <i
                                        class="fa fa-chevron-down accor-down-icon font-size-10 ms-auto"></i>
                                </a>
					   ...
					   <?php
						...
						foreach ($folders as $f) {
                            ...
                            ?>
                              <li><a href="?action=filemanager&p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><?php echo fm_convert_win(fm_enc($f)) ?>
                       ...
                       <!--<li>
                        ...
                        <li>
                            <a href="?action=filemanager&p=&shared" class="text-body d-flex align-items-center">
                                <i class="fa fa-share-alt font-size-14 me-2"></i> <span class="me-auto">Shared</span>
                            </a>
                        </li>
                        <li>
                            <a href="?action=filemanager&p=&starred" class="text-body d-flex align-items-center">
                                <i class="fa fa-star-o text-muted font-size-14 me-2"></i><span
                                    class="me-auto">Starred</span></a>
                            </a>
                        </li>
                        <li>
                            <a href="?action=filemanager&p=&trash" class="text-body d-flex align-items-center">
                                <i class="fa fa-trash text-danger font-size-14 me-2"></i> <span
                                    class="me-auto">Trash</span>
                            </a>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="text-body d-flex align-items-center">
                               <i class="fa fa-cog text-muted font-size-14 me-2"></i> <span
                ...
                <!--div class="w-100">
                    <div class="alert alert-success alert-dismissible fade show px-3 mb-0" role="alert">
                        <button type="button" class="btn-close font-size-10" data-bs-dismiss="alert" aria-label="Close"></button>
                        <div class="mb-3">
                            <i class="fa fa-folder-open h3 text-success"></i>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="text-center">
                                <button type="button" class="btn btn-link text-decoration-none text-success text-capitalize">Upgrade <i
                                        class="fa fa-arrow-right font-size-10 mx-1"></i></button>
                            </div>
                        </div>
                    </div>
                </div-->
                            ...
                            <div class="">
                                ...
                                <div class="avatar-xs me-3 mb-3">
                                    <div class="avatar-title bg-transparent rounded">
                                        <i class="fa fa-folder font-size-24 text-warning"></i>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    <div class="overflow-hidden me-auto">
                                        <h5 class="font-size-14 text-truncate mb-1"><a href="javascript: void(0);"
                                                class="text-body"><a href="?action=filemanager&p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><?php echo fm_convert_win(fm_enc($f)) ?>
                                            </a><?php echo($is_link ? ' &rarr; <i>' . readlink($path . '/' . $f) . '</i>' : '') ?></a></h5>
                                        <p class="text-muted text-truncate mb-0 text-300"><?php echo $cfilecount; ?> Files</p>
                                    </div>
                            ...
                            <tr id="<?php echo $ii ?>">
                                <?php if (!FM_READONLY): ?>
                                    ...
                                    <td data-sort=<?php echo fm_convert_win(fm_enc($f)) ?>>
										...
										<a href="?action=filemanager&p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')).'&sharedu='.$_GET['sharedu'] ?>"><i class="<?php echo $img ?>"></i> <?php echo fm_convert_win(fm_enc($f)) ?>
                                            </a>
											<?php } else { ?>
										<a href="?action=filemanager&p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="<?php echo $img ?>"></i> <?php echo fm_convert_win(fm_enc($f)) ?>
                                            </a>
										<?php } ?>
						...
						foreach ($files as $f) {
                            ...
                            <tr id="<?php echo $ik; ?>">
                                ...
                                <div class="dropdown">
									...
									<li> <a class="dropdown-item" title="<?php echo lng('Preview') ?>" href="<?php echo $filelink.'&quickView=1'; ?>" data-mdb-toggle="modal" data-mdb-target="#previewModal<?php echo $ik; ?>" data-title="<?php echo fm_convert_win(fm_enc($f)) ?>" data-max-width="100%" data-width="100%"><?php echo lng('Preview') ?></a></li>
...
function fm_show_nav_path($path)
{
    ...
    ?>
    <nav class="navbar-file navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
          ...
          <?php
            ...
            <div class="filemanager-search">
                <div class="d-flex search-wrap">
                    <div class="form-outline w-100">
                        <input type="text" class="form-control" aria-label="<?php echo lng('Search') ?>" aria-describedby="v-addon2" id="search-addon">
            ...
            <div class="home-right-nav ms-lg-2">
                <ul class="navbar-nav mr-auto justify-content-end <?php echo fm_get_theme();  ?>">
                    <?php/* if (!FM_READONLY): ?>
                    <li class="nav-item">
                        <a title="<?php echo lng('Upload') ?>" class="nav-link" href="?action=filemanager&p=<?php echo urlencode(FM_PATH) ?>&amp;upload"><i class="fa fa-cloud-upload" aria-hidden="true"></i> <?php echo lng('Upload') ?></a>
                    </li>
                    <li class="nav-item">
...
<head>
    ...
    <style>
        ...
        #search-addon { font-size:15px;border-right-width:0;min-height: 45px;padding: 10px 15px; }
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content <?php echo fm_get_theme(); ?>">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary m-0" onclick="newfolder('<?php echo fm_enc(FM_PATH) ?>');return false;"><i class="fa fa-check-circle"></i> <?php echo lng('CreateNow') ?></button>
                </div>
            </div>
        </div>
    </div>
       ...
       success:function(data){
		    //call again the ajax function 
		      ...
		      if(data.success == true){
			      ...
			      /*$('.response-error').show();
				  $("#error-message").html('Successfully Starred');
					setTimeout(function() {
       ...
       success:function(data){
		    //call again the ajax function 
		      if(data.success == true){
				  ...
				  /*$('.response-error').show();
				  $("#error-message").html('Successfully Send To Trash');
					setTimeout(function() {
					$('.response-error').fadeOut('fast');
					}, 2000); // <-- time in milliseconds*/
					
					$("#"+data.rowid).remove();
					$("#basic-primary-trash-trigger").trigger('click'); 
				}
			},
		  error: function(errorThrown){
			console.log(errorThrown);
...
<script>
    ...
    function newfolder(e) {
        ...
        null !== t && "" !== t && n && (window.location.hash = "#", window.location.search = "action=filemanager&p=" + encodeURIComponent(e) + "&new=" + encodeURIComponent(t) + "&type=" + encodeURIComponent(n))
    }
    function rename(e, t) {var n = prompt("New name", t);null !== n && "" !== n && n != t && (window.location.search = "action=filemanager&p=" + encodeURIComponent(e) + "&ren=" + encodeURIComponent(t) + "&to=" + encodeURIComponent(n))}
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data) {
                    ...
                    if(data.done) {
						toast('Uploaded Successful: '+data.done.name);
