                            ...
                            <tr>
                                <?php if (!FM_READONLY): ?>
                                    ...
                                    <td data-sort=<?php echo fm_convert_win(fm_enc($data['file_name'])); ?>>
                                        <div class="filename"><a href="?action=filemanager&p=<?php echo urlencode(trim(('shared/'.$data['root_path'] != '' ? '/' . 'shared/'.$data['root_path'] : '') . '/' . $data['file_name'], '/')) ?>"><span class="thumb"><i class="<?php echo $img ?>"></i></span> <?php echo fm_convert_win(fm_enc($data['file_name'])) ?>
                                            </a><?php echo($is_link ? ' &rarr; <i>' . readlink($sharedpath . '/' . $f) . '</i>' : '') ?></div>
                                    </td>
                                ...
                                <td class="inline-actions">
                                    <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <li> <a class="dropdown-item" title="<?php echo lng('DirectLink')?>" href="?action=filemanager&p=<?php echo urlencode(trim(('shared/'.$data['root_path'] != '' ? '/' . 'shared/'.$data['root_path'] : '') . '/' . $data['file_name'], '/')) ?>" target="_blank"><?php echo lng('DirectLink')?></a><li>
                                            <?php if (!FM_READONLY): ?>
												...
												<li><a class="dropdown-item" title="<?php echo lng('Delete') ?>" href="?action=filemanager&p=&amp;shared&amp;shareddel=<?php echo $data['id'] ?>" onclick="return confirm('<?php echo lng('Remove from share').' '.lng('Folder').'?'; ?>\n \n ( <?php echo urlencode($data['file_name']) ?> )');"> <?php echo lng('Delete') ?></a></li>
                                                 <?php } ?>
											<?php endif; ?>
                                           </ul>
                                    </div>
                                    ...
                                    <li><a class="dropdown-item" title="<?php echo lng('Download') ?>" href="?action=filemanager&p=<?php echo urlencode($data['root_path']) ?>&amp;dl=<?php echo urlencode($data['file_name']) ?>"><?php echo lng('Download') ?></a></li>
                                        <?php if (!FM_READONLY): ?>
                                           ...
                                           <!-- <li><a href="#" onclick="checkit('<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>')"><span>Starred</span></a>--> 
											...
											?>
											<li><hr class="dropdown-divider" /></li>
											<li><a class="dropdown-item" title="<?php echo lng('Delete') ?>" href="?action=filemanager&p=&amp;shared&amp;shareddel=<?php echo $data['id'] ?>" onclick="return confirm('<?php echo lng('Remove from share').' '.lng('File').'?'; ?>\n \n ( <?php echo urlencode($data['file_name']) ?> )');"> <?php echo lng('Delete') ?></a></li>
                                            <?php } ?>
										<?php endif; ?>
                                    </ul>
                                </td>
