						  ...
						  $is_link = is_link($trashpath . '/' . $data['file_name']);
                            ...
                            <tr id="<?php echo $itrash ?>">
                                <?php if (!FM_READONLY): ?>
                                    <td class="custom-checkbox-td">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="<?php echo $itrash ?>" name="file[]" value="<?php echo fm_enc($f) ?>">
                                    ...
                                    <td data-sort=<?php echo fm_convert_win(fm_enc($data['file_name'])) ?>>
                                        <div class="filename"><a href="?action=filemanager&p=<?php echo urlencode(trim(($data['root_path'] != '' ? '/' . $data['root_path'] : '') . '/' . $data['file_name'], '/')) ?>"><span class="thumb"><i class="<?php echo $img ?>"></i></span> <?php echo fm_convert_win(fm_enc($data['file_name'])) ?>
                                            </a><?php echo($is_link ? ' &rarr; <i>' . readlink($trashpath . '/' . $f) . '</i>' : '') ?></div>
                                    </td>
							...
							$filelink = '?action=filemanager&p=' . urlencode('trash/'.$data['root_path']) . '&amp;view=' . urlencode($data['file_name']);	
							  ...
							  <tr id="<?php echo $itrash ?>">
                                ...
                                <td class="inline-actions">
                                <div class="dropdown">
                                    <a class="font-size-16 text-muted" href="#" role="button" id="trashDropdownMenuLink" data-mdb-toggle="dropdown" aria-expanded="false" > <i class="fa fa-ellipsis-h"></i>
                                    </a>
